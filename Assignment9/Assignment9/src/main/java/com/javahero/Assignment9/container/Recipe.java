package com.javahero.Assignment9.container;
...
public class Recipe {
	...
	public Recipe(Integer cookingMinutes2, Boolean dairyFree2, Boolean glutenFree2, String instructions2,
			Double preparationMinutes2, Double pricePerServing2, Integer readyInMinutes2, Integer servings2,
			Double spoonacularScore2, String title2, Boolean vegan2, Boolean vegetarian2) {
